...
public class MyVolleySingleton {
     ...
     */
    public void sendObjectRequest(int requestMethod, String url, JSONObject jsonObject, final HashMap<String, String> parameters, final VolleyResponseListener callback) {
...
//                      TODO Add headers
     ...
     */
    public void sendArrayRequest(String url, final VolleyResponseListener callback) {
